...
module.exports = async (parts : Array<string>, req: express.Request, res: express.Response, path: _base.PATH, models : {[key: string]: _db.BaseModel}, io: any, router : _route.Router) => {
    ...
    if (controller?.toLowerCase() !== 'favicon.ico') {
        ...
        await obj.initialize(req, res, models, io);
